...
export default function FloatingRecommendation({
  ...
  return (
    <>
      ...
      >
        <TouchableOpacity activeOpacity={0.9} onPress={handleViewFull}>
          <View
            style={{
              maxWidth: 320,
              ...
              <>
                ...
                >
                  ...
                  >
                    <View
                      style={{
                        ...
                        marginRight: 10,
                        backgroundColor:
                          getEmotionAccentColor(dominantEmotion) + "15",
                        borderWidth: 1,
                        borderColor:
                          getEmotionAccentColor(dominantEmotion) + "25",
                      }}
                    >
                      <LottieView
                        source={getEmotionLottie(dominantEmotion)}
                        autoPlay
                        loop
                        speed={1}
                  ...
                  <View
                    style={{
                      backgroundColor:
                        getEmotionAccentColor(dominantEmotion) + "20",
                      paddingHorizontal: 8,
                      paddingVertical: 4,
                      borderRadius: 12,
                      marginLeft: 8,
                ...
                {hasRecommendations && (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {t("emotion.counselor.recommendations")} (
